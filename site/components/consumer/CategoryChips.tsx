        ...
        <div className="hide-scrollbar flex gap-3 overflow-x-auto pb-2.5 pr-1">
          {items.map((item) => (
            <button
              ...
              className="flex min-w-[174px] snap-start items-center gap-3.5 rounded-[1rem] border border-white/10 bg-[#07111f]/76 px-4 py-4 text-left shadow-[0_22px_60px_-40px_rgba(15,23,42,1)] transition-all duration-300 hover:border-violet-400/24 hover:bg-[#0b1526] sm:min-w-[196px] sm:gap-4 sm:rounded-[1.1rem] sm:px-5 sm:py-4"
            >
              <span
                className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/14 text-[1.1rem] sm:h-11 sm:w-11 sm:text-2xl"
