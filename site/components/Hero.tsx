      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-10 pt-6 sm:px-6 sm:pb-12 sm:pt-8 lg:pb-16 lg:pt-14">
        ...
        <div className="mx-auto min-w-0 max-w-[36rem] text-center lg:mx-0 lg:max-w-[48rem] lg:text-left">
          ...
          <h1 className="mx-auto mt-4 max-w-[20rem] font-[var(--font-display)] text-[1.85rem] font-black leading-[1.02] tracking-[-0.04em] text-white sm:max-w-[34rem] sm:text-[2.65rem] lg:mx-0 lg:max-w-[38rem] lg:text-[3.2rem] xl:text-[3.45rem]">
            <span className="block">Tu menú digital listo para que tus</span>
            <span className="block bg-[linear-gradient(180deg,#fde047_0%,#facc15_48%,#eab308_100%)] bg-clip-text text-transparent">
              clientes escaneen, elijan y ordenen.
            </span>
          </h1>
          ...
          <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row lg:items-start lg:justify-start">
            <Link
              ...
              className="group animate-fade-up animation-delay-500 relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-[#FACC15] px-6 py-4 text-base font-bold text-[#0B0F1A] shadow-[0_34px_90px_-18px_rgba(250,204,21,1)] transition-all duration-300 hover:scale-[1.04] hover:bg-[#fde047] hover:shadow-[0_40px_100px_-16px_rgba(250,204,21,1)] active:scale-95 sm:min-w-[17.5rem] sm:w-auto sm:px-9"
            >
        ...
        <div className="animate-fade-up animation-delay-300 relative mx-auto flex w-full min-w-0 max-w-[22rem] justify-center pt-2 sm:max-w-[28rem] lg:-mt-2 lg:max-w-[44rem] lg:justify-end lg:pt-0 xl:max-w-[46rem]">
          <div
            aria-hidden="true"
            className="hero-orbit-system absolute left-1/2 top-1/2 h-[20rem] w-[20rem] -translate-x-1/2 -translate-y-1/2 opacity-55 sm:h-[26rem] sm:w-[26rem] sm:opacity-70 lg:left-[58%] lg:h-[42rem] lg:w-[42rem] lg:opacity-100 xl:left-[60%]"
          >
          ...
          <div className="relative z-20 w-full max-w-[18rem] sm:max-w-[24rem] lg:max-w-[40rem] xl:max-w-[42rem]">
            <div className="relative mx-auto w-full pl-0 sm:pl-2 lg:mr-0 lg:pl-8 xl:pl-10">
              <div className="animate-fade-up animation-delay-500 absolute -left-1 bottom-[2%] z-20 w-[7.5rem] sm:-left-2 sm:bottom-[3%] sm:w-[9.5rem] lg:-left-6 lg:bottom-[4%] lg:w-[12.5rem] xl:-left-8 xl:w-[14rem]">
                <Image
                  src="/branding/table-tent.png"
                  alt="Table Tent en acrílico con QR de elmenuxfa"
                  width={560}
                  height={746}
                  className="h-auto w-full select-none drop-shadow-[0_28px_70px_rgba(0,0,0,0.55)]"
                  priority
                />
              </div>

              <div className="animate-fade-up animation-delay-500 absolute left-[18%] top-[8%] z-30 hidden w-[10.5rem] rounded-[1.35rem] border border-white/10 bg-[linear-gradient(180deg,rgba(34,39,78,0.9),rgba(20,25,49,0.82))] px-3.5 py-3 text-white shadow-[0_24px_64px_-28px_rgba(124,58,237,0.72)] backdrop-blur-2xl sm:block lg:left-[10%] lg:top-[10%] lg:w-[11.5rem] lg:px-4 lg:py-4 xl:left-[8%]">
                <div className="flex items-start justify-between gap-2">
                  <p className="text-[0.82rem] font-medium text-slate-100 lg:text-[0.95rem]">Incluye</p>
                  <Layers className="h-4 w-4 text-[#FACC15]" />
                </div>
                <p className="mt-2 text-[1.05rem] font-black leading-tight tracking-[-0.04em] text-white lg:text-[1.35rem]">
                  Table Tent
                  <br />
                  físico
                </p>
                <p className="mt-1.5 text-[0.78rem] leading-5 text-slate-200/92 lg:text-[0.92rem] lg:leading-6">
                  QR listo para
                  <br />
                  colocar en mesa
                </p>
              ...
              <Image
                ...
                height={1536}
                priority
                className="animate-float-slow relative z-10 mx-auto h-auto w-full max-w-[17.5rem] select-none drop-shadow-[0_36px_90px_rgba(0,0,0,0.68)] sm:max-w-[22rem] lg:ml-auto lg:max-w-[34rem] lg:drop-shadow-[0_48px_120px_rgba(0,0,0,0.82)] xl:max-w-[36rem]"
              />
            </div>
          </div>
        </div>
