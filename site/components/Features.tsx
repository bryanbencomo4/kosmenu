...
export function Features() {
  return (
    <section id="beneficios" className="border-t border-white/8">
      <div className="mx-auto grid max-w-7xl gap-6 px-5 py-14 sm:px-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-start lg:py-20">
        <div className="rounded-[1.6rem] border border-white/10 bg-[#0b111d]/86 p-6 shadow-[0_28px_90px_-50px_rgba(0,0,0,1)] sm:rounded-[1.8rem] sm:p-7">
          ...
          <h2 className="mt-4 max-w-md font-[var(--font-display)] text-[2rem] font-black leading-[1.02] tracking-[-0.03em] text-white sm:mt-5 sm:text-[2.45rem]">
            Una plataforma para vender mejor sin depender de catálogos manuales
          </h2>
          <p className="mt-4 max-w-lg text-sm leading-7 text-slate-400 sm:mt-5 sm:text-[15px]">
        ...
        {features.map(({ title, description, icon: Icon }) => (
          <article
            key={title}
            className="rounded-[1.35rem] border border-white/10 bg-[#0c1320]/90 p-5 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.95)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-violet-400/30 hover:bg-[#101828] sm:rounded-[1.55rem]"
          >
